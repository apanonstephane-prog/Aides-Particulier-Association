      ...
      <main className="pt-24 pb-20">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
          ...
          <Section title="Éditeur du site">
            <p>
              Le site <strong>Aides Connect</strong> (accessible à l&apos;adresse{" "}
              <em>aides-connect.fr</em>) est édité par :
            </p>
          ...
          <Section title="Propriété intellectuelle">
            <p>
              L&apos;ensemble des contenus présents sur le site Aides Connect (textes, structure,
              organisation des pages) est la propriété de l&apos;éditeur, sauf mentions contraires.
            </p>
            <p>
              Toute reproduction, représentation, modification ou exploitation totale ou partielle
              des contenus, sans autorisation expresse de l&apos;éditeur, est interdite et
              constituerait une contrefaçon.
            </p>
            <p>
              Les informations relatives aux dispositifs d&apos;aide sont issues de sources
              publiques. Les formulaires officiels restent la propriété des organismes publics
              concernés.
            </p>
          </Section>
          ...
          <Section title="Responsabilité">
            <p>
              Les informations présentées sur Aides Connect sont fournies à titre informatif. Elles
              ne constituent ni une décision administrative, ni un avis juridique ou fiscal.
            </p>
            <p>
              L&apos;éditeur s&apos;efforce de maintenir des informations exactes et à jour, mais ne
              peut garantir l&apos;exhaustivité, l&apos;exactitude ou l&apos;actualité des contenus
              publiés. L&apos;éligibilité à une aide est toujours déterminée par l&apos;organisme
              officiel compétent.
            </p>
            <p>
              L&apos;éditeur ne saurait être tenu responsable d&apos;un préjudice résultant d&apos;une
              utilisation des informations présentées sur le site.
            </p>
          </Section>

          <Section title="Liens hypertextes">
            <p>
              Le site peut contenir des liens vers des sites tiers (organismes publics, formulaires
              officiels). L&apos;éditeur n&apos;exerce aucun contrôle sur ces sites et décline toute
